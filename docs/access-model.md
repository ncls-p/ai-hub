...
4. Pour une personne déjà présente, choisir **Modifier le rôle**. Le choix remplace ses rôles directs de projet dans une transaction, après vérification des droits retirés et accordés. Les accès hérités de l’organisation et des équipes restent applicables. La colonne **Rôle d’organisation** propose **Nommer admin orga** auprès des personnes éligibles. Le dialogue précise l’organisation concernée et les droits accordés : administration de ses membres et projets, et nomination d’autres administrateurs d’organisation. Les attributions personnalisées et les accès d’équipe restent disponibles dans les détails.
...
- **Organisations et projets** gère la structure, séparément des rôles de personnes dans **Membres et droits**. Les organisations homonymes restent des entités distinctes ; leurs projets et, en dernier recours, un identifiant court les différencient dans le répertoire et les sélecteurs de partage.
