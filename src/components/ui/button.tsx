...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-xl border border-transparent bg-clip-padding text-sm font-semibold whitespace-nowrap shadow-[0_12px_30px_-18px_color-mix(in_oklch,var(--foreground)_40%,transparent)] transition-[background-color,border-color,color,box-shadow,transform,opacity] duration-200 outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-[linear-gradient(135deg,color-mix(in_oklch,var(--primary)_92%,white),color-mix(in_oklch,var(--primary)_76%,var(--ring)))] text-primary-foreground hover:shadow-[0_18px_40px_-18px_color-mix(in_oklch,var(--primary)_60%,transparent)]",
        outline:
          "border-border/80 bg-background/70 text-foreground hover:border-ring/40 hover:bg-background aria-expanded:bg-muted aria-expanded:text-foreground dark:border-input dark:bg-input/30 dark:hover:bg-input/50",
        secondary:
