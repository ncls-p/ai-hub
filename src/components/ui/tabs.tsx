...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-full border border-border/70 bg-background/55 p-1 text-muted-foreground shadow-[inset_0_1px_0_0_color-mix(in_oklch,white_35%,transparent)] backdrop-blur group-data-horizontal/tabs:min-h-11 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none data-[variant=line]:border-0 data-[variant=line]:bg-transparent data-[variant=line]:p-0 data-[variant=line]:shadow-none",
  {
    variants: {
      variant: {
        default: "bg-muted",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-active:border-border/80 data-active:bg-background/90 data-active:text-foreground dark:data-active:border-input dark:data-active:bg-input/40 dark:data-active:text-foreground",
